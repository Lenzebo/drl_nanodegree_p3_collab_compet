...
1. install the necessary preconditions for the deep reinforcement learning nanodegree (i.e. UnityEnvironment, ....)
2. Download the Tennis environment provided above  
3. Install pip packages from `requirments.txt`
